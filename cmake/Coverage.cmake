...
if(NOT STARSHIPSIMULATOR_BUILD_TESTS)
    message(FATAL_ERROR "STARSHIPSIMULATOR_ENABLE_COVERAGE needs STARSHIPSIMULATOR_BUILD_TESTS=ON")
endif()
...
set(coverage_targets StarshipSimulator_tests)
