...
if(STARSHIPSIMULATOR_SANITIZERS AND MSVC)
    message(FATAL_ERROR "STARSHIPSIMULATOR_SANITIZERS needs GCC or Clang (asan/tsan presets: Linux, macOS)")
endif()
...
function(StarshipSimulator_configure_target target)
    if(MSVC)   # cl, and clang-cl (which takes the same options)
        target_compile_options(${target} PRIVATE
            ...
            $<$<BOOL:${STARSHIPSIMULATOR_WARNINGS_AS_ERRORS}>:/WX>)
    elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
        ...
        if(STARSHIPSIMULATOR_SANITIZERS)
            ...
            if("address" IN_LIST STARSHIPSIMULATOR_SANITIZERS)
